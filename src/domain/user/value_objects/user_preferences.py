...
class UserPreferences:
    ...
    def __post_init__(self):
        ...
        if self.preferred_decoder not in valid_decoders:
            object.__setattr__(self, 'preferred_decoder', "nhtsa")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "autodev_api_key": self.autodev_api_key,
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'UserPreferences':
        ...
        return cls(
            preferred_decoder=data.get("preferred_decoder", "nhtsa"),
            ...
            autodev_api_key=data.get("autodev_api_key"),
    ...
    def with_api_key(self, api_key: Optional[str]) -> 'UserPreferences':
        """Create new preferences with updated API key."""
        return UserPreferences(
            preferred_decoder=self.preferred_decoder,
            include_market_value=self.include_market_value,
            include_history=self.include_history,
